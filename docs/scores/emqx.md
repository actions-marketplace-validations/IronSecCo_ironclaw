---
title: "emqx:5 container isolation score: 63/100 (grade C)"
description: "How isolated is emqx:5 by default? IronClaw scores its sandbox posture 63/100 (C): retains default capabilities. Scan any container in 10s."
---

# emqx:5 container isolation score: 63/100 (grade C)
...
|-----------|:-------:|------:|---------------------|
| Non-root user (uid != 0) | ✅ PASS | 15/15 | runs as emqx (uid != 0) |
...
Applying these to your `docker run emqx` targets the biggest gaps first (most points at stake first):
...
# grade your own emqx the same way this page was generated
